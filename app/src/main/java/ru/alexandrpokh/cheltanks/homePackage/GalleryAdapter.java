...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.MyViewHolder>{
    ...
    public GalleryAdapter(Context context,List<PhotoCard> photocardList) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View photoView = inflater.inflate(R.layout.gallery_thumbs, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        PhotoCard photocardItem = photocardList.get(position);

        ImageView imageView = holder.photo;

        Glide.with(mContext)
                .load(photocardItem.getPhoto())
